...
calc_trans(const GridDescBaseDevice &grid, const GF3D5layout &layout5,
           ...
           const array<GF3D5<const T>, 3> &tl_duI,
           const array<GF3D5<const T>, 6> &tl_dduI, const GF3D2layout &layout2,
...
calc_trans(const GridDescBaseDevice &grid, const GF3D5layout &layout5,
           ...
           const array<array<GF3D5<const T>, 3>, 3> &tl_duI,
           const array<array<GF3D5<const T>, 6>, 3> &tl_dduI,
...
calc_trans(const GridDescBaseDevice &grid, const GF3D5layout &layout5,
           ...
           const array<array<GF3D5<const T>, 3>, 6> &tl_duI,
           const array<array<GF3D5<const T>, 6>, 6> &tl_dduI,
           const GF3D2layout &layout2, const array<const T *, 9> &gf_Jac,
           const array<const T *, 18> &gf_dJac) {
  for (int a = 0; a < 6; ++a)
    calc_trans<CI, CJ, CK>(grid, layout5, tl_duO[a], tl_dduO[a], tl_duI[a],
