...
SetOutputFile[FileNameJoin[{Directory[], "transderivsinline.hxx"}]];
...
SetMainPrint[
  ...
  PrintInitializations[{Mode -> "Derivs", DerivsOrder -> 1}, DuInVarlist];
  PrintInitializations[{Mode -> "Derivs", DerivsOrder -> 2}, DDuInVarlist];
  pr[];
